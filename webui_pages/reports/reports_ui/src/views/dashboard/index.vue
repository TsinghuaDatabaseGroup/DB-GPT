...
import { alertHistories, alertHistoryDetail, diagnose_llm_model_list } from '@/api/api'
import Vue from 'vue'
...
export default {
  ...
  methods: {
    ...
    getDiagnoseLlmModelList() {
      diagnose_llm_model_list().then(res => {
