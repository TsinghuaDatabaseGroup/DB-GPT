...
def get_parser():
    ...
    parser.add_argument("--algo_conf", type=str,
                        default = '../query_rewrite/configs/instruction_induction.yaml')
    ...
    parser.add_argument("--eval_dataset", type=str, default="imdbload") # for index tuning
