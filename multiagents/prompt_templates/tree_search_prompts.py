...
Remember: All the thoughts is SHORT, at most 3 sentence!
Let's Begin!
...
DEFAULT_POLICY_STATE_CHANGE_USER_FUNCTION = """The Above is the former state changes in one of the former trails, and You will make some difference from now on.
After this trail, you will make some reflection to inherit to later trails."""


VOTE_BEST_SYSTEM_PROMPT='''You are mento-carlo-choice-GPT. Some agents are performing some task by mento-carlo search method and already made some trails. Your task is to decide which trail is the best.
