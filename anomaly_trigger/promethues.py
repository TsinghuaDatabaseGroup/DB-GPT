...
# Prometheus的API URL
prometheus_api_url = 'xxxx'

# 查询CPU使用率的PromQL，示例仅作为参考，具体查询可能需要调整
cpu_query = '100 - (avg by (instance) (irate(node_cpu_seconds_total{instance="172.27.58.65:9100",mode="idle"}[5m])) * 100)'

# 查询内存使用量的PromQL
memory_query = '(node_memory_MemTotal_bytes{instance="172.27.58.65:9100"} - node_memory_MemAvailable_bytes{instance="172.27.58.65:9100"}) / node_memory_MemTotal_bytes{instance="172.27.58.65:9100"} * 100'
